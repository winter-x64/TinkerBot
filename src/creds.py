...
class FirebaseCreds(NamedTuple):
    ...
    auth_provider_x509_cert_url: str = os.environ.get('FIREBASE_AUTH_PROVIDER_X509_CERT_URL')
    ...
    def to_json(self) -> Dict[str, str]:
        var = [i for i in vars(FirebaseCreds).keys() if not i.startswith('_') and i != 'to_json']
